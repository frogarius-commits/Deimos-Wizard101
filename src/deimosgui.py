...
class GUIKeys:
	...
	# CSR
	CSRDrums = "csrdrums"
	LocationTeleport = "locationteleport"
...
def create_gui(gui_theme, gui_text_color, gui_button_color, tool_name, tool_version, gui_on_top, langcode):
	...
	VVR_buttons_layout = [[hotkey_button_sized('P1 Drums', GUIKeys.VVRDrums, False, gui_text_color, gui_button_color, (13, 1))],
					    [gui.Text(tl('Disabled'), key=f'VVRDrumsStatus', auto_size_text=False, size=(7, 1), text_color=gui_text_color)],
						[gui.HorizontalSeparator(color='white', pad=((0, 0),(3, 3)))],
					    [hotkey_button_sized('P1 Auto Chest', GUIKeys.AutoChest, False, gui_text_color, gui_button_color, (13, 1))],
	...
	CRR_hotkeys_layout = [[hotkey_button_sized('Get Rope', GUIKeys.RopePort, False, gui_text_color, gui_button_color, (8, 1))],
	...
	GCR_toggles_layout= [[hotkey_button('Silver Tokens', GUIKeys.AutoSilverTokens), gui.Text(tl('Disabled'), key='SilverTokenStatus', auto_size_text=False, size=(7, 1), text_color=gui_text_color), 
gui.Combo(['Snake', 'Spider', 'Crane', 'Butterfly', 'Tree'], default_value='Tree', readonly=True, text_color=gui_text_color, size=(8, 1), key='SilverInput')],
...
gui.Combo(['Snake', 'Spider', 'Crane', 'Butterfly', 'Tree'], default_value='Tree', readonly=True, text_color=gui_text_color, size=(8, 1), key='GoldInput')],
[hotkey_button('Wood Tokens', GUIKeys.AutoWoodTokens), gui.Text(tl('Disabled'), key='WoodTokenStatus', auto_size_text=False, size=(7, 1), text_color=gui_text_color), 
gui.Combo(['Snake', 'Spider', 'Crane', 'Butterfly', 'Tree'], default_value='Tree', readonly=True, text_color=gui_text_color, size=(8, 1), key='WoodInput')],
	...
	while running:
		...
		match event:
			...
			case GUIKeys.toggle_speedhack | GUIKeys.toggle_combat | GUIKeys.toggle_dialogue | GUIKeys.toggle_sigil | \
				...
				GUIKeys.toggle_camera_collision | GUIKeys.MisfortuneTears | GUIKeys.CacaoPods | \
				GUIKeys.VVRDrums | GUIKeys.CSRDrums | GUIKeys.QuetzalEggs | \
				GUIKeys.AutoTracyFoldersForensic | GUIKeys.AutoTracyFoldersBombshell: 
				send_queue.put(GUICommand(GUICommandType.ToggleOption, event))

			case GUIKeys.AutoChest:
				send_queue.put(GUICommand(GUICommandType.AutoChest, inputs["Chest_Type"]))
			...
			case GUIKeys.LocationTeleport:
				send_queue.put(GUICommand(GUICommandType.LocationTeleport, inputs['CSR_Location']))

			case GUIKeys.SouthToken:
				send_queue.put(GUICommand(GUICommandType.SouthToken, inputs['South_Token']))
			...
			case GUIKeys.SendAll:
				send_queue.put(GUICommand(GUICommandType.SendAll))
